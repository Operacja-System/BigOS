...
void pmm_set_memory_regions_as_reserved(); //TODO: Implement (it doesn't have to be called this, this is just an information that such function needs to be implemented)
