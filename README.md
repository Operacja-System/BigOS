...
Complete information about build system can be found in [build system docs](build_system/).  
...
Documentation is available at [github pages](https://bartex00001.github.io/BigOS).
